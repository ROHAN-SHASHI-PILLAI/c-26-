...
var computerCollisions=Matter.SAT.collides(
  playerArrows[i].body,
  computer.body
);
...
function handleComputerArrowCollision() {
  ...
  for(var i=0;i<computerArrows;i++){
    var baseCollision=Matter.SAT.collides(
    ...
    var archerCollision=Matter.SAT.collides(
      computererArrows[i].body,
      playerArcher.body
    );
    
    var playerCollisions=Matter.SAT.collides(
      computerArrows[i].body,
      player.body
    );
